 ...
 * by 4 and still be less than the integer representation of the number which
 * follows,** we know that we have to subtract the integer representation of I,
 * X or C from the total. (**The number which follows is known because this
 * approach iterates over the string from back to front.)
 */
